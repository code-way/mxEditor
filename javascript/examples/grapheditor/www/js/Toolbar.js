...
Toolbar.prototype.init = function()
{
	...
	var elts = this.addItems(['-', 'saveAs', 'save']);
	elts[1].setAttribute('title', mxResources.get('saveAs') + ' (' + this.editorUi.actions.get('saveAs').shortcut + ')');
	elts[2].setAttribute('title', mxResources.get('save') + ' (' + this.editorUi.actions.get('save').shortcut + ')');
	elts[2].innerHTML='<div style="display: flex;align-items: center;margin-right: 20px; display: block"><i class="material-icons" style="color:#0080ff;margin-right: 5px;vertical-align: text-bottom;">save</i><a style="color: #3399ff;text-decoration: none;" href="#">save</a></div>';
	 elts[2].style.textAlign='center';
	 elts[2].style.fontSize='large';
	 elts[2].style.padding='1px 60px 4px 6px';
	 elts[1].innerHTML='<button style="color:#0458E3">update</button>';
	 elts[1].style.textAlign='center';
	 elts[1].style.fontWeight='bold';
	 elts[1].style.fontSize='small';
	 elts[1].style.padding='0px 320px 4px 1px';
	// elts[1].style.color='Red';
	// if (sw >= 320)
	// {
...
Toolbar.prototype.createTextToolbar = function()
{
	...
	var elts = this.addItems(['-', 'saveAs', 'save','-', 'bold', 'italic', 'underline']);
	elts[1].setAttribute('title', mxResources.get('saveAs') + ' (' + this.editorUi.actions.get('saveAs').shortcut + ')');
	elts[2].setAttribute('title', mxResources.get('save') + ' (' + this.editorUi.actions.get('save').shortcut + ')');
