...
Getting Started
===============
first install xampp in your system
run xampp by using command sudo /opt/lampp/lampp start
clone the files and put into /opt/lampp/htdocs/
run the server using url
localhost/mxEditor/mxgraph/javascript/examples/grapheditior/www/

for save the generated xml
$ run the command npm install $ install postgresql database $ run on url http://localhost:3000
